                                ...
                                <div class="card-body card-form p-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-4 col-md-6">
                                            ...
                                            <input type="text" placeholder="location" value="{{ $job->location }}" id="location" name="location" class="form-control">
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" placeholder="Website" value="{{ $job->company_website }}" id="company_website" name="company_website" class="form-control">
                                    </div>
                                </div>
